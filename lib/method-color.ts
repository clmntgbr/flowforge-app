export const GetMethodColor = (method: string) => {
  const colors: Record<string, string> = {
    GET: "bg-blue-200 text-blue-700 border-blue-700/20 border",
    POST: "bg-green-200 text-green-700 border-green-700/20 border",
    PUT: "bg-amber-200 text-amber-700 border-amber-700/20 border",
    DELETE: "bg-red-200 text-red-700 border-red-700/20 border",
    PATCH: "bg-purple-200 text-purple-700 border-purple-700/20 border",
    HEAD: "bg-blue-200 text-blue-700 border-blue-700/20 border",
    OPTIONS: "bg-purple-200 text-purple-700 border-purple-700/20 border",
  }
...
export const GetMethodCodeColor = (method: string) => {
  const colors: Record<string, string> = {
    GET: "bg-blue-200 text-blue-700",
    POST: "bg-green-200 text-green-700",
    PUT: "bg-amber-200 text-amber-700",
    DELETE: "bg-red-200 text-red-700",
    PATCH: "bg-purple-200 text-purple-700",
    HEAD: "bg-blue-200 text-blue-700",
    OPTIONS: "bg-purple-200 text-purple-700",
  }
